...
为指导自己平时的技术学习，我决定建立一个路线图（或者叫技能树）。
...
最终内容的可视化效果可[点此](http://app.joelz.me/skill-set/)查看。
...
- Skill Set
    ...
    - 编程语言
        - [JavaScript](https://developer.mozilla.org/en-US/docs/JavaScript)/[Node.js](http://nodejs.org/)/C#/Swift/Python
    ...
    - 切页面
        ...
        - [PhotoShop](http://www.photoshop.com/products/photoshop)/[Paint.net](http://www.getpaint.net/)/[Sketch](http://bohemiancoding.com/sketch/)
    - 开发工具
        - 编辑器和IDE
            - [Notepad++](http://notepad-plus-plus.org/
            - [Visual Studio](http://www.visualstudio.com/)/[Visual Studio Code](https://code.visualstudio.com/)
            - [Coding WebIDE](https://ide.coding.net/dashboard)
    ...
    - 代码质量
        - Coding style
            - [JSLint](http://www.jslint.com/)/[ESLint](https://github.com/eslint/eslint)
    ...
    - 可视化
        - SVG/Canvas/VML
        - SVG: [D3](http://d3js.org/)/[Snap.svg](http://snapsvg.io/)/[DataV](http://datavlab.org/datavjs/)
